...
//we will read from file input.txt
    ...
    string myText;
    label:
    cout<<"Welcome to AES encryption"<<endl;
    cout<<endl;
    cout<<"Enter your choice "<<endl;
    cout<<"1- Encoding (128-bit)"<<endl;
    cout<<"2- Decoding (128-bit)"<<endl;
    cout<<"3- Encoding (192-bit)"<<endl;
    cout<<"4- Decoding (192-bit)"<<endl;
    cout<<"5- Encoding (256-bit)"<<endl;
    cout<<"6- Decoding (256-bit)"<<endl;
    cout<<"7- Exit"<<endl;
    cin>>choice;
    ...
    switch(choice)
    {
        ...
        {
            int keySize = 128;
            if(choice == 3) keySize = 192;
            else if(choice == 5) keySize = 256;
...
//getting key from key.txt
                    ...
                    unsigned char key[32];                    // Maximum key size for AES
                    unsigned int x;
...
//encrypting our plain text
                    ...
                    for(int i=0;i<extendedlength;i+=16)
                    {
                        ...
                        double durationEncrypt = getTime(startEncrypt, endEncrypt);
                        cout << "Time taken for encryption: " << durationEncrypt << " seconds" << endl;
                        for(int j=0;j<16;j++)
                        {
...
//storing our encrypted data in encryption.aes     
                ...
                cout<<keySize<<"-bit AES encryption is done sucessfully\n";
        ...
        {
            int keySize = 128;
            if(choice == 4) keySize = 192;
            else if(choice == 6) keySize = 256;
...
//printing our plain text
    ...
    goto label;                                                             // Returning to the menu
}
